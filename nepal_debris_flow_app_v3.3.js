/*******************************************************************************
 * NEPAL DEBRIS FLOW — DOWNSTREAM EXPOSURE, IMAGERY & RAINFALL ANOMALY  (v3.3)
 * Rasuwa River Valley (28.279 N, 85.378 E) — event 2026-08-25
 *
 * v3.3 — stable release with performance optimizations & SAR error handling:
 *   • vectorization: maxPixels 1e10 → 1e8, tileScale 4 → 2
 *   • HAND inundation: tileScale 4 → 2, scale 90 → 100, eightConnected off
 *   • SAR filtering: clipped to AOI + guard clauses for empty collections
 *
...
citationBox.add(ui.Label('Pennan Chinnasamy, Surajit Ghosh, Somdeep, Ushashi, Arpan, Sneha', {
  fontSize: '11px', fontWeight: 'bold', color: T.navy,
  backgroundColor: '#ffffff', margin: '0 0 2px 2px'
}));
